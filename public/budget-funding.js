...
function bfEnsure(){
  ...
  document.getElementById('bf-month').value=bfTarget||bfNextMonth();
  document.getElementById('bf-month')?.addEventListener('change',e=>{bfTarget=e.target.value||bfNextMonth();bfLoad(true)});
